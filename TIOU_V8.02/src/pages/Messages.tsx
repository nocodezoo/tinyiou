  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      ...
      {recentRecipients.length > 0 && (
        <div className="mb-6">
          <p className="text-xs font-bold uppercase text-zinc-500 mb-3">Quick Chat</p>
      ...
      <div className="flex gap-4 md:gap-6 h-[60vh]">
        {/* Chat List - Dark */}
        <div className="w-48 md:w-56 flex-shrink-0 bg-zinc-800 rounded-2xl p-3 space-y-2 overflow-y-auto">
          <h2 className="font-bold text-zinc-500 text-xs uppercase mb-3">Recent</h2>
          {chatUsers.length === 0 ? (
