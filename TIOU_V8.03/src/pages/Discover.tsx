    ...
    <div className="max-w-2xl mx-auto px-4">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-zinc-500 text-sm">Find souls to acknowledge</p>
        </div>
      </div>
      ...
      <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-4 mb-6">
        <div className="flex gap-3">
          ...
          <button 
            onClick={searchUsers} 
            disabled={loading}
            className="px-6 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg transition-colors disabled:opacity-50"
          >
            {loading ? '...' : 'Search'}
          </button>
        </div>
        ...
        {displayUsers.length === 0 ? (
          ...
          displayUsers.map((u: any, i: number) => (
            ...
            >
              ...
              <Link 
                to="/create" 
                className="px-4 py-2 border border-zinc-700 hover:border-orange-500 text-zinc-400 hover:text-orange-500 rounded-lg text-sm font-medium transition-colors"
              >
                Send IOU
              </Link>
            </motion.div>
