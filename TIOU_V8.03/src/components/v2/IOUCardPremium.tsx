...
export default function IOUCardPremium({ iou, index }: IOUCardPremiumProps) {
  ...
  // Check for user uploaded media
  const userMedia = iou.media_urls && iou.media_urls.length > 0 ? iou.media_urls[0] : null
  ...
  return (
    ...
    >
      {/* Background - User uploaded image OR taxonomy backdrop */}
      <div className="absolute inset-0 z-0">
        {userMedia ? (
          // User uploaded image/video
          <>
          ...
          // Default taxonomy backdrop
          <img 
            src={taxonomyBackdrop} 
            alt="" 
