          ...
          >
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center">
              ...
              <motion.div
                ...
                className="mb-1"
              >
                <h2 className="font-display text-6xl md:text-8xl lg:text-9xl font-black tracking-tight"><span className="text-white">Tiny</span><span className="electric-glow-subtle">IOU</span></h2>
              </motion.div>
