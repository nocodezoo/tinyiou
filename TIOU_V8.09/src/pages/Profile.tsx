...
export default function Profile() {
  ...
  if (!profile) return <div className="text-center py-20 card"><h2 className="text-2xl font-bold mb-4">Profile not found</h2><Link to="/" className="btn-primary"><ArrowLeft className="w-20 h-20" />Back to Home</Link></div>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Link to="/" className="inline-flex items-center gap-2 text-surface-muted hover:text-surface-text mb-6"><ArrowLeft className="w-20 h-20" />Return to Ledger</Link>
