        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 backdrop-blur-md border border-orange-500/20 rounded-3xl p-10 min-h-[300px] flex flex-col justify-center overflow-hidden"
            >
              ...
              <div className="absolute bottom-0 right-1/4 w-48 h-48 bg-amber-500/10 rounded-full blur-3xl"></div>
              <div className="relative z-10 text-center">
                <p className="text-3xl md:text-4xl font-black text-white font-display leading-relaxed">
                ...
                <p className="text-3xl md:text-4xl font-black text-white font-display leading-relaxed mt-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 backdrop-blur-md border border-amber-500/20 rounded-3xl p-10 min-h-[300px] flex flex-col justify-center overflow-hidden"
            >
              <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30 rounded-3xl"></div>
              <div className="absolute top-0 right-1/4 w-64 h-64 bg-amber-500/10 rounded-full blur-3xl"></div>
              <div className="absolute bottom-0 left-1/4 w-48 h-48 bg-yellow-500/10 rounded-full blur-3xl"></div>
              <p className="text-3xl md:text-4xl font-black text-white font-display leading-relaxed relative z-10 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
            {frequencies.map((freq, i) => (
              ...
              >
                ...
                <p className="text-white font-black text-base mb-1">{freq.label}</p>
                <p className="text-zinc-400 text-sm">{freq.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
