      ...
      <AnimatePresence>
        {!hideHero && (
          <motion.section 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0, y: -50 }}
            className="relative min-h-screen flex flex-col items-center justify-center px-6 md:px-12 py-32 overflow-hidden"
          >
            {/* Background Effects */}
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center">
              ...
              >
                <p className="text-orange-400 font-medium tracking-[0.3em] uppercase text-sm mb-6">
              ...
              <motion.h1 
                ...
                className="font-display text-5xl md:text-7xl lg:text-8xl font-bold leading-[0.9] tracking-tight mb-8"
              >
              ...
              <motion.p 
                ...
                className="text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed mb-12 font-serif italic"
              >
